    ...
    public class Program
    {
        static void Main(string[] args)
        {
           /* Console.WriteLine("How many wheels does your vehicle have?");
            ...
            var myVehicle=  VehicleFactory.GetVehicle(answer);
            myVehicle.Drive();
           */
            ...
            bool answer=false;
            do {
                Console.WriteLine("How many wheels does your new vehicle have?");
                answer = int.TryParse(Console.ReadLine(), out numOfWheels);
                var newVeh = VehicleFactory.GetVehicle(numOfWheels);
                newVeh.Drive();
            }
            while (answer== false);
        }
